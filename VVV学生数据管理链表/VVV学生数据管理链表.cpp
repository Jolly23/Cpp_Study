// VVV学生数据管理链表.cpp : Defines the entry point for the console application.



//项目规划：使用链表malloc实现数据的 增删改查 功能，优化用户交互度
//严禁内存泄露


//2015年7月28日发布 V1.0：	实现基础功能及存档
//2015年7月28日		V1.1：	优化功能，简化代码，可以通过多种方式修改、删除数据
//2015年8月 3日		V1.3：	优化大量代码，使用回调函数，提上代码复用率
